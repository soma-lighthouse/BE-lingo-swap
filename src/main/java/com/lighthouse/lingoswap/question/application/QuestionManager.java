...
public class QuestionManager {
    ...
    public ResponseDto<Object> create(final QuestionCreateRequest questionCreateRequest) {
        Member member = memberRepository.findByAuthDetailsUuid(questionCreateRequest.uuid())
                .orElseThrow(() -> new MemberNotFoundException(questionCreateRequest.uuid()));
    ...
    public ResponseDto<QuestionListResponse> read(final String memberUuid, final Long categoryId, final Long nextId, final int pageSize) {
        ...
        Member member = memberRepository.findByAuthDetailsUuid(memberUuid)
        ...
        List<QuestionDetail> results = questions.content().stream().map(q ->
                new QuestionDetail(q.getId(), q.getContents(), q.getLike(),
                        q.getCreatedMemberUuid(), q.getCreatedMemberName(), q.getCreatedMemberRegion(), distributionService.generateUri(q.getCreatedMemberProfileImageUri()),
